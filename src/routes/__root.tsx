...
import { SupportAssistantProvider } from "@/components/site/SupportAssistant";
...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "PCI01 Support Website US" },
      {
        name: "description",
        content: "United States support site for the PCI01 Pet Thermometer.",
      },
      { property: "og:type", content: "website" },
      { property: "og:site_name", content: "PCI01 Support Website US" },
